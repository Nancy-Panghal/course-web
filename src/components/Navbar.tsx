    ...
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
      ...
      <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8">
          <Link href="/#features" className="nav-link text-sm">Features</Link>
          <Link href="/#how-it-works" className="nav-link text-sm">How it works</Link>
      ...
      {menuOpen && (
        <div className="md:hidden border-b px-6 py-4 flex flex-col gap-4"
          ...
          <Link href="/#features" className="nav-link text-sm" onClick={() => setMenuOpen(false)}>Features</Link>
          <Link href="/#how-it-works" className="nav-link text-sm" onClick={() => setMenuOpen(false)}>How it works</Link>
          <Link href="/#pricing" className="nav-link text-sm" onClick={() => setMenuOpen(false)}>Pricing</Link>
          <Link href="/contact" className="nav-link text-sm" onClick={() => setMenuOpen(false)}>Contact</Link>
          {!user && (
            <Link href="/login"
