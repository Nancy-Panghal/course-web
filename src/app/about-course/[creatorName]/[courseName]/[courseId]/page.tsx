import { Shield, CheckCircle, Lock, BookOpen, Play, Zap, Globe, Calendar, Timer, Send, Star, Users, Award, ChevronRight, Target } from 'lucide-react'
...
export default async function AboutCoursePage({
  ...
  // Section visibility — default everything to true for backwards compatibility
  const DEFAULT_SECTIONS = {
    stats: true, target: true, learn: true, requirements: true,
    curriculum: true, instructor: true, testimonials: true, howItWorks: true, faq: true,
  }
  const sec: Record<string, boolean> = { ...DEFAULT_SECTIONS, ...(course.landing_sections || {}) }
