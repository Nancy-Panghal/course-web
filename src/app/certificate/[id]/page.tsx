    ...
    <div style={{ minHeight: '100vh', background: '#080808' }}>
      ...
      <nav style={{
        ...
        <Link href="/" style={{ display: 'flex', alignItems: 'center', gap: 8, textDecoration: 'none' }}>
          ...
          <span style={{ fontWeight: 700, color: '#fff', fontSize: 15 }}>Kurso</span>
        </Link>
      ...
      <div style={{ maxWidth: 680, margin: '0 auto', padding: '48px 16px 80px' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 32 }}>
          ...
          <p style={{ color: '#52525b', fontSize: 13, marginTop: 10 }}>
            This certificate is authentic and was issued by Kurso.
          </p>
        </div>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <p style={{ fontSize: 12, color: '#5c3f1a', margin: 0 }}>issued by Kurso</p>
          </div>
          ...
          <div style={{ padding: '36px 32px 28px', textAlign: 'center' }}>
            ...
            <div style={{
              ...
              {[
                ...
                { icon: BookOpen, label: 'Platform',      value: 'Kurso' },
          ...
          <div style={{
            ...
            <span style={{ fontSize: 11, color: '#52525b' }}>
              Verified on Kurso · Certificate ID: <span style={{ color: '#71717a', fontFamily: 'monospace' }}>{cert.certificate_id}</span>
            </span>
          </div>
        </div>
        ...
        <div style={{
          ...
          <p style={{ fontSize: 12, color: '#71717a', margin: 0, lineHeight: 1.6 }}>
            This certificate was automatically generated by Kurso upon verified course completion.
